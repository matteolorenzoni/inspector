...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // Schermata da cui deve partire l'applicazione
...
// Con stato
// Widget vero e proprio, è associato ad uno State Object
// Ha il compito di fare il re-render una volta che lo stato è cambiato
...
// Stato del widget
// Permette di salvare uno stato (della logica che si mantiene)
